...
router.get('/territorial-maturity', requireRole(['SUPER_ADMIN', 'OPERATOR', 'TERRITORIAL_OPERATOR', 'TERRITORIAL_MANAGER']), applyTerritoryScope, async (req: Request, res: Response) => {
  try {
...
router.get('/history', requireRole(['SUPER_ADMIN', 'OPERATOR', 'TERRITORIAL_OPERATOR', 'TERRITORIAL_MANAGER']), async (req: Request, res: Response) => {
  try {
