...
- [ ] `GOOGLE_MAPS_API_KEY` preenchida (sem expor valor em docs)
- [ ] `EXPO_PUBLIC_PLACES_KEY` preenchida (sem expor valor em docs)
...
- [ ] Key Google Maps permite package `com.kaviar.passenger`
- [ ] Key Google Maps permite SHA-1 `D8:58:D3:A5:D1:79:1E:E3:E7:DD:E9:74:52:91:AD:0F:C8:A2:59:83`
