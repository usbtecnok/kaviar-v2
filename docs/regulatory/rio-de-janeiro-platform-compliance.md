...
- Documento institucional e juridico-operacional.
- Nao implementa regra de produto.
- Nao altera backend, frontend, app, banco, seed, flags, CRM, workflows ou AWS.

## Status interno recomendado
...
## Leitura operacional em 2026

- Existe competencia regulatoria municipal para o tema.
- O regime geral de 2021 foi descontinuado no decreto-base.
- Nao ha, na auditoria oficial concluida, confirmacao de rito geral sucessor para automoveis com os mesmos elementos de 2021.
- A KAVIAR deve manter consulta formal ativa com a SMTR antes de qualquer automacao de obrigacoes antigas.

## REGIME HISTORICO DE 2021 - DECRETO 48.612 REVOGADO EM 2023

- Decreto Rio no 48.612/2021: base historica do regime de 2021.
- Decreto Rio no 48.666/2021: alteracoes no decreto-base historico.
- Resolucao Conjunta SMTR/SMFP no 048/2021: instrumento infradecretal associado ao bloco de 2021.
- Tratamento interno: historico documental, sem presuncao de vigencia operacional atual.

## DECRETO 51.934/2023

- O art. 1o revogou expressamente o Decreto Rio no 48.612/2021.
- Diretriz de compliance: remover presuncao de obrigatoriedade automatica derivada do decreto revogado.
...
- Escopo especifico para motocicletas por aplicativos e condutores parceiros desse segmento.
- Nao estender automaticamente essas regras para modalidade CAR.

## O que NAO tratar como obrigacao vigente automatica em 2026

- Taxa/preco publico de 1,5% como rotina ativa.
- Emissao/pagamento de DARM especifico com prazo fixo do bloco de 2021.
- Credenciamentos CPPAPP e CPMAPP como rito atual confirmado.
- Envio mensal CSV geral nos moldes da Resolucao 048/2021.
- Requisitos de motorista e veiculo baseados exclusivamente nos Decretos 48.612/48.666.

## Plano institucional minimo

- Manter protocolo de consulta formal com a SMTR para obter confirmacao escrita de ato e canal atualmente aplicaveis ao escopo CAR.
- Registrar resposta oficial e atualizar este documento sem inferencia automatica.
- Somente apos confirmacao formal, discutir eventual implementacao tecnica em fluxo separado.
...
## Observacao de mudanca

Atualizacao documental realizada para refletir a auditoria oficial encerrada em 15/07/2026.
