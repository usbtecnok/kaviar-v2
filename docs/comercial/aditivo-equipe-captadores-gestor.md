...
O Gestor Territorial, no exercício de suas atribuições junto à plataforma KAVIAR, poderá organizar equipe própria de captadores, consultores ou apoio local para auxiliar na expansão e operação do território.

## 2. Responsabilidades do Gestor Territorial
...
- Membros da equipe devem agir com ética, respeito e transparência;
- Não é permitido realizar captação agressiva, enganosa ou que prejudique a imagem do KAVIAR;
- Qualquer descumprimento pode resultar na inativação do cadastro pelo Gestor ou pela central KAVIAR.
