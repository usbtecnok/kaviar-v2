# Mensagens WhatsApp — Convite Gestor Fundador KAVIAR

---

## Mensagem 1 — Convite direto (curta)
...
Não é promessa de ganho; tudo depende de apuração, contrato e validação da central.
```

---

## Mensagem 2 — Para pessoa que já demonstrou interesse

```
Fala! Lembra que você perguntou sobre o KAVIAR?
...
## Mensagem 3 — Para liderança comunitária ou associação

```
Bom dia! Sou [nome], e estou trabalhando com o KAVIAR — plataforma de mobilidade comunitária.
...
## Mensagem 4 — Follow-up após enviar proposta

```
E aí, conseguiu ver a proposta do Gestor Fundador KAVIAR?
