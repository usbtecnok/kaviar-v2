...
| Pergunta | Objetivo |
|----------|----------|
| Quantos moradores a associação representa? | Dimensionar potencial |
| Já existe algum grupo de corridas na comunidade? | Validar demanda |
| Quantos motoristas locais vocês conhecem? | Estimar oferta |
