...
interface VirtualFenceCenterCardProps {
  driverId: string;
}

interface VirtualFenceCenter {
  lat: number;
  lng: number;
}
...
export const VirtualFenceCenterCard: React.FC<VirtualFenceCenterCardProps> = ({ driverId }) => {
  const { token, admin } = useAuth();
  const [center, setCenter] = useState<VirtualFenceCenter | null>(null);
