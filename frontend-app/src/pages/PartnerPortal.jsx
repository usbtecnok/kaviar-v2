            ...
            {user?.referral_code && (
              <Box sx={{ textAlign: 'center', p: 3, border: '1px solid #222', borderRadius: 2, mb: 3 }}>
                ...
                <Box sx={{ display: 'flex', gap: 1, justifyContent: 'center', mt: 2, flexWrap: 'wrap' }}>
                  ...
                  <Button size="small" variant="outlined" sx={{ borderColor: '#333', color: '#4caf50' }} onClick={() => { navigator.clipboard.writeText('https://downloads.kaviar.com.br/kaviar-passageiro-v1.13.7-kaviar-local-l1.apk'); alert('Link copiado!'); }}>Copiar link passageiro</Button>
                </Box>
              </Box>
            )}
          </Box>
