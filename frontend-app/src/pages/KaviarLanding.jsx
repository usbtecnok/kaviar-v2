      ...
      <Box id="downloads" sx={{ ...sx.section, py: { xs: 4, md: 7 } }}>
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', lg: '1fr 1fr' }, gap: 3 }}>
          ...
          <Box sx={{ borderRadius: 6, border: `1px solid ${gold}20`, background: 'linear-gradient(135deg, #1b1608, #0c0b08)', p: { xs: 4, md: 5 }, boxShadow: `0 30px 120px rgba(212,175,55,0.08)` }}>
            ...
            <Button variant="contained" href="https://downloads.kaviar.com.br/kaviar-motorista-v1.11.7-aceite-sem-piscar.apk" target="_blank" rel="noopener" sx={sx.goldBtn}>
          ...
          <Box sx={{ ...sx.card, p: { xs: 4, md: 5 } }}>
            ...
            <Button variant="outlined" href="https://downloads.kaviar.com.br/kaviar-passageiro-v1.11.3-compensation.apk" target="_blank" rel="noopener" sx={sx.outlineBtn}>
