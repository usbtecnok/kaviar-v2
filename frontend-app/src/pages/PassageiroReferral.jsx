...
export default function PassageiroReferral() {
  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: '#1a1a1a', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <Container maxWidth="sm" sx={{ textAlign: 'center', py: 6 }}>
        ...
        <Typography variant="h5" sx={{ color: '#fff', fontWeight: 700, mb: 2 }}>Chame corridas com a KAVIAR</Typography>
        <Typography sx={{ color: '#aaa', mb: 3, lineHeight: 1.6 }}>
          Baixe o app de passageiro, faça seu cadastro{ref ? ` e use o código ${ref}` : ''} para começar a usar a KAVIAR na sua região.
        </Typography>
